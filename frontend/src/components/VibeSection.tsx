...
const reels = [
  {
    ...
    text: "Places on Earth that don't feel real",
  },
  {
  ...
  {
    img: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?q=80&w=2070",
  ...
  return (
    <section className="section-wrapper bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <h2
          className="section-heading text-center text-navy mb-8"
          style={{
            fontSize: titleSize
