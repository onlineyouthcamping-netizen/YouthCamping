      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          {(title || subtitle) && (
            <div className="mb-6">
              {title && (
                <h2 className="text-3xl font-bold text-navy capitalize tracking-tighter">
                  {title}
                </h2>
              )}
              {subtitle && (
                <p className="text-zinc-600 font-bold mt-2 tracking-widest text-[10px] capitalize">
                  {subtitle}
                </p>
              )}
            </div>
                  ...
                  <motion.div
                    ...
                    className={cn(
                      ...
                      activeVideos.length > 1
                        ...
                        : "w-full",
                      hasSelfHosted
                        ? "cursor-pointer group/video active:scale-[0.98]"
                  ...
                  >
                    <div className="relative aspect-[16/8.5] md:aspect-[21/9] rounded-[20px] md:rounded-[32px] overflow-hidden mb-4 shadow-[0_12px_24px_rgba(0,0,0,0.12)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.18)] hover:-translate-y-1.5 transition-all duration-500 border-0">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-3 md:p-4 bg-gradient-to-t from-black/60 to-transparent">
                        <p className="text-[11px] md:text-xs font-bold text-white line-clamp-1">
                          {video.title}
                        </p>
                      </div>
                    </div>
