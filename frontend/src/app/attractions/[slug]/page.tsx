  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="relative h-[70vh] w-full overflow-hidden">
        <OptimizedImage
          src={
            normalizeImageUrl(attraction.image) ||
            "https://images.unsplash.com/photo-1520209759395-820217e92824"
          }
          alt={attraction.name}
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-10 md:p-20 text-white">
          <div className="max-w-4xl space-y-4">
            ...
            <h1 className="text-5xl md:text-8xl font-bold tracking-tighter italic capitalize leading-[0.8]">
              {attraction.name}
            </h1>
            <p className="text-lg md:text-xl font-medium opacity-80 max-w-2xl">
              {attraction.category}
              {attraction.altitude ? ` • ${attraction.altitude}` : ""}
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-3xl font-bold text-navy capitalize tracking-tighter italic">
                  Overview
                </h2>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {attraction.faqs.map((faq: any, i: number) => (
                    <div
                      key={i}
                      className="p-8 border border-zinc-100 rounded-[32px] hover:border-primary-orange/20 transition-all group"
                    >
            ...
            <div className="sticky top-32 space-y-8">
              <div className="p-10 bg-primary-orange rounded-[40px] text-white shadow-xl shadow-orange-100 relative overflow-hidden group">
                <div className="relative z-10 space-y-6">
                  <h3 className="text-2xl font-bold capitalize tracking-tighter leading-tight italic">
                    Experience {attraction.name} with us
                  </h3>
                  <p className="text-sm opacity-90 font-medium">
                    Join our curated Spiti expeditions to explore this magical
                    place and many others.
                  </p>
                  <Link
                    href="/trips"
                    className="w-full h-14 bg-white text-primary-orange rounded-2xl flex items-center justify-center font-bold capitalize text-[10px] tracking-widest hover:bg-navy hover:text-white transition-all shadow-xl"
                  >
                    View Expeditions
                  </Link>
                </div>
