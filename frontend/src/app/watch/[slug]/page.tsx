  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="absolute top-0 left-0 right-0 z-50 p-6 md:p-10 flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent">
        <Link
          href="/"
          className="group flex items-center gap-3 text-white/60 hover:text-white transition-colors font-bold capitalize text-[10px] tracking-widest"
        >
        ...
        <div className="flex items-center gap-4 invisible"></div>
      </div>
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10 items-end justify-between">
            <div className="max-w-3xl space-y-6">
              <div className="flex items-center gap-4">
                <span className="px-3 py-1 bg-primary text-white text-[10px] font-bold capitalize tracking-widest rounded-md">
                  Cinematic
                </span>
                <span className="text-[10px] font-bold capitalize tracking-widest text-white/40">
                  Travel Documentary
                </span>
              </div>
              ...
              <div className="flex items-center gap-8">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[9px] font-bold capitalize tracking-widest text-white/40">
                      Directed By
                    </span>
            ...
            <div className="flex flex-col gap-4 items-end invisible"></div>
          </div>
        </div>
      </div>
